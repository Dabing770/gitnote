...
![Viisi kertaa viisi -ruudukko, jonka kaikki 25 ruutua ovat tyhjiä ja valkoisia.](assets/26-figure-01.svg)
...
![Sama viisi kertaa viisi -ruudukko, jonka vasemman alanurkan ruutu on tummennettu poistetun ruudun merkiksi ja loput 24 ruutua ovat tyhjiä.](assets/26-figure-02.svg)
...
![Sama ruudukko väritettynä kolmella värillä, punaisella, vihreällä ja sinisellä, niin että saman värin ruudut muodostavat lävistäjän suuntaisia vinojonoja. Vasemman alanurkan poistettu ruutu on tummennettu. Jäljelle jäävistä ruuduista yhdeksän on punaista ja seitsemän sinistä.](assets/26-figure-03.svg)
...
![Viisi kertaa viisi -ruudukko väritettynä kolmella värillä vinoraidoin, jotka laskevat vasemmalta ylhäältä oikealle alas. Ruudukossa on yhdeksän punaista, kahdeksan vihreää ja kahdeksan sinistä ruutua.](assets/26-figure-04.svg)

 

![Sama viisi kertaa viisi -ruudukko väritettynä samoilla kolmella värillä, mutta vinoraidat kulkevat peilikuvana toiseen suuntaan, vasemmalta alhaalta oikealle ylös. Tässäkin värityksessä on yhdeksän punaista, kahdeksan vihreää ja kahdeksan sinistä ruutua.](assets/26-figure-05.svg)
...
Säännönmukaisuus alkaa erottumaan: lukujen ollessa $1, 2, \ldots, n$ on vastaus

$$(n+1)! - 1 = 1 \cdot 2 \cdot 3 \cdot \ldots \cdot (n+1) - 1.$$

 Lukuja tulee siis jotenkin kasvattaa yhdellä.
...
![Kymmenen kertaa kymmenen -ruudukko, jonka vasemmassa alakulmassa on punaisella väritetty noin kymmenen ruudun ryhmä. Loput ruudut ovat valkoisia.](assets/26-figure-06.svg)
...
![Seitsemän ruutua leveä ja viisi ruutua korkea ruudukko, jonka sisällä on paksuja mustia seiniä eri ruutujen välissä. Kolme robottia on merkitty mustina neliöinä eri puolille ruudukkoa: yksi vasemmassa alanurkassa, yksi keskellä ylhäällä ja yksi oikealla alhaalla.](assets/26-figure-07.svg)
...
![Kahdeksan kertaa kahdeksan -ruudukko, jonka sisällä on paksuja mustia seiniä. Kaksi robottia on merkitty mustina neliöinä. Punainen murtoviiva kulkee mutkitellen seinien välistä ensimmäisen robotin ruudusta toisen robotin ruutuun ja esittää robottien siirtosarjan.](assets/26-figure-08.svg)
