...
![Kolmio ABC ympärysympyränsä sisällä. Ympyrän keskipiste O on merkitty, katkoviiva yhdistää sen kärkeen B, ja pisteen B kautta kulkeva tangenttisuora jatkuu pisteeseen D.](14%20Geometriset%20konfiguraatiot.assets/tangenttiversio2.svg)
...
![Sama kolmio ABC ympärysympyrineen kuin edellä, nyt kulmat merkittyinä. Kärjen A kulma on merkitty, keskuskulma pisteessä O on kaksi kertaa tämä kulma, kulma OBC on 90 astetta miinus kärjen A kulma, ja tangentin ja jänteen välinen kulma DBC on yhtä suuri kuin kärjen A kulma.](14%20Geometriset%20konfiguraatiot.assets/tangenttiversio3.svg)
...
![Kolmio ABC ja sen sisäympyrä, jonka keskipiste on I. Ympyrä sivuaa sivua BC pisteessä D, sivua AC pisteessä E ja sivua AB pisteessä F. Katkoviivat yhdistävät kärjet keskipisteeseen I.](14%20Geometriset%20konfiguraatiot.assets/sisaympyra.svg)
...
![Edellinen sisäympyräkuvio, johon on lisätty sivuamispisteiden erottamien tangenttijanojen pituudet: kärjestä A lähtevät janat AF ja AE ovat molemmat pituudeltaan x, kärjestä B lähtevät BF ja BD ovat y, ja kärjestä C lähtevät CE ja CD ovat z.](14%20Geometriset%20konfiguraatiot.assets/sisaympyraXYZ.svg)
...
![Kolmio ABC ympärysympyrineen sekä sisäympyrän keskipiste I. Katkoviivainen ympyrä kulkee pisteiden B, I ja C kautta, ja sen keskipiste M on merkitty.](14%20Geometriset%20konfiguraatiot.assets/sivuympyra.svg)

*$M$ on kolmion $BIC$ ympärysympyrän keskipiste.*

Jatketaan suoraa $AI$ pisteen $M$ yli kolmion $BIC$ ympärysympyrälle:

![Sama kuvio kuin edellä, ja suora kärjestä A pisteiden I ja M kautta on jatkettu pisteeseen J katkoviivaympyrän kehälle, jolloin jana IJ on tämän ympyrän halkaisija.](14%20Geometriset%20konfiguraatiot.assets/sivuympyra2.svg)
...
![Sama kuvio täydennettynä sinisellä ympyrällä, jonka keskipiste on J. Tämä on kärjen A vastainen sivuympyrä: se sivuaa sivua BC sekä sivujen AB ja AC jatkeita, jotka on piirretty pisteiden B ja C ohi pisteisiin X ja Y.](14%20Geometriset%20konfiguraatiot.assets/sivuympyra3.svg)
...
![Ympyrä ja sen ympärille piirretty nelikulmio ABCD, jonka jokainen sivu sivuaa ympyrää. Kyseessä on tehtävän 2 sisäympyrällinen nelikulmio.](14%20Geometriset%20konfiguraatiot.assets/pitot.svg)
...
![Kolmio ABC, jonka korkeusjanat BE ja CF on piirretty katkoviivoin ja osuvat sivuille pisteisiin E ja F. M on sivun BC keskipiste, ja siitä on piirretty janat pisteisiin E ja F. Kuvassa näkyy myös kolmion AEF ympärysympyrä.](14%20Geometriset%20konfiguraatiot.assets/tangentslemma.svg)
...
![Kolmio ABC ja sen kolme korkeusjanaa katkoviivoin, jotka leikkaavat pisteessä H. Korkeusjanojen kannat sivuilla ovat D, E ja F. Lisäksi on merkitty janan AH keskipiste X ja sivun BC keskipiste M.](14%20Geometriset%20konfiguraatiot.assets/yhdeksan.svg)
...
![Kolmio ABC ympärysympyrineen ja ympyrän kehällä oleva piste D. Pisteestä D on piirretty pistekatkoviivoin kohtisuorat sivuille tai niiden jatkeille, ja kantapisteet X, Y ja Z ovat samalla suoralla.](14%20Geometriset%20konfiguraatiot.assets/simson.svg)
