...
![Kuusi kertaa kuusi -ruudukko, jonka punaisella väritetyt ruudut muodostavat porrasmaisen reitin vasemmasta alanurkasta oikeaan ylänurkkaan edeten vain oikealle ja ylöspäin.](01%20Induktiivinen%20päättely.assets/01-figure-01.svg)
...
![Sama ruudukko, jonka vasemman alanurkan lähimpiin ruutuihin on kirjoitettu reittien määrät: alarivillä ja vasemmassa reunassa lukee 1 ja lähimmissä sisäruuduissa kasvavat luvut 2, 3, 4 ja 6.](01%20Induktiivinen%20päättely.assets/01-figure-02.svg)
...
![Täysi kuusi kertaa kuusi -ruudukko, jonka jokaiseen ruutuun on merkitty reittien määrä. Luvut kasvavat reunojen ykkösistä sisäruutuja kohti ja oikeassa ylänurkassa lukee 252.](01%20Induktiivinen%20päättely.assets/01-figure-03.svg)
...
![Kolme suoraa, jotka leikkaavat toisiaan lähellä keskustaa ja jakavat tason muutamaan lohkomaiseen alueeseen. Alueita ei ole vielä väritetty.](01%20Induktiivinen%20päättely.assets/01-figure-04.svg)
...
![Samat kolme suoraa neliömäisen alueen sisällä, ja niiden rajaamat alueet on väritetty harmaalla ja valkoisella niin, etteivät mitkään kaksi vierekkäistä aluetta ole samanvärisiä.](01%20Induktiivinen%20päättely.assets/01-figure-05.svg)

Tutkitaan sitten tilannetta, jossa suoria on yksi enemmän.

![Edelliseen kuvioon on lisätty uusi suora punaisella. Vanha harmaa-valkoinen väritys on ennallaan, joten punaisen suoran eri puolilla on nyt vierekkäisiä samanvärisiä alueita.](01%20Induktiivinen%20päättely.assets/01-figure-06.svg)
...
![Punaisen suoran yläpuolella olevien alueiden värejä on alettu vaihtaa päinvastaisiksi, mutta osa yläpuolen alueista on vielä vaihtamatta.](01%20Induktiivinen%20päättely.assets/01-figure-07.svg)

Väritystä pitää tietysti muuttaa vielä muidenkin uuden suoran yläpuolella olevien alueiden kohdalla:

![Kaikki punaisen suoran yläpuolella olevat alueet on nyt vaihdettu päinvastaiseen väriin, ja harmaa-valkoinen väritys on jälleen kelvollinen, kun mitkään kaksi vierekkäistä aluetta eivät ole samanvärisiä.](01%20Induktiivinen%20päättely.assets/01-figure-08.svg)
...
![Nelikulmio, johon on piirretty punaisella sen kaksi lävistäjää.](01%20Induktiivinen%20päättely.assets/01-figure-09.svg)

![Viisikulmio, johon on piirretty punaisella sen viisi lävistäjää.](01%20Induktiivinen%20päättely.assets/01-figure-10.svg)
