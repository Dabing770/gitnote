...
![Pisteet A ja B sekä niiden yläpuolella pisteet X ja Y. Kummastakin pisteestä X ja Y on jana pisteisiin A ja B, ja kulmat AXB ja AYB on merkitty punaisella yhtä suuriksi. Ympyrää ei ole piirretty.](06%20Jännenelikulmiot.assets/jannenelikulmio.svg)
...
![Kolme erillistä pistettä A, B ja C, jotka eivät ole samalla suoralla. Muuta ei ole piirretty.](06%20Jännenelikulmiot.assets/kolmepistetta.svg)
...
![Pisteet A, B ja C. Pisteiden B ja C välinen jana on piirretty pisteviivalla, ja sen keskinormaali eli janan keskeltä kohtisuoraan kulkeva suora on piirretty kokonaan.](06%20Jännenelikulmiot.assets/keskinormaali.svg)
...
![Pisteet A, B ja C. Sekä janan BC että janan AB keskinormaalit on piirretty suorina, ja ne leikkaavat toisensa yhdessä pisteessä. Itse janat BC ja AB on merkitty pisteviivoin.](06%20Jännenelikulmiot.assets/kaksinormaalia.svg)
...
![Pisteet A, B ja C sekä janojen keskinormaalit, jotka leikkaavat pisteessä O. Pisteen O ympärille on piirretty ympyrä, joka kulkee kaikkien kolmen pisteen A, B ja C kautta.](06%20Jännenelikulmiot.assets/ymparysympyra.svg)
...
![Pisteet A ja B sekä niiden yläpuolella pisteet X ja Y. Molemmista pisteistä X ja Y on jana pisteisiin A ja B, ja kulmat AXB ja AYB on merkitty punaisella yhtä suuriksi.](06%20Jännenelikulmiot.assets/jannenelikulmio.svg)
...
![Ympyrä, jonka kehällä pisteet A, B ja X. Piste Y on piirretty ympyrän ulkopuolelle. Kulmat AXB ja AYB on merkitty punaisella yhtä suuriksi.](06%20Jännenelikulmiot.assets/toinensuunta.svg)
...
![Sama kuva, johon on lisätty piste Y-pilkku eli kohta, jossa jana BY leikkaa ympyrän kehän. Myös kulma pisteessä Y-pilkku on merkitty punaisella.](06%20Jännenelikulmiot.assets/toinensuunta2.svg)
...
![Sama kuva kulmamerkinnöillä: kulmat pisteissä X, Y ja Y-pilkku ovat kaikki alfa, ja kulma pisteessä Y-pilkku janan suunnassa on 180 astetta miinus alfa. Kolmion, jonka kärjet ovat A, Y ja Y-pilkku, kolmas kulma jää nollaksi asteeksi, mikä on mahdotonta.](06%20Jännenelikulmiot.assets/toinensuunta3.svg)
...
![Pisteet A ja B, piste X janan AB yläpuolella ja piste Y sen alapuolella. Molemmista pisteistä on janat pisteisiin A ja B, ja kulmat AXB ja BYA on merkitty punaisella. Ympyrää ei ole piirretty.](06%20Jännenelikulmiot.assets/vastakkaisetToinensuunta.svg)
...
![Nelikulmio ABCD, johon on piirretty lävistäjät AC ja BD. Kulma CBA on suora eli 90 astetta (punaisella), kulma BAC on 70 astetta ja kulma ADB on 20 astetta (sinisellä).](06%20Jännenelikulmiot.assets/egmo.svg)
...
![Kolmio ABC ja sen kolme korkeusjanaa kärjistä A, B ja C vastakkaisille sivuille jalkoihin D, E ja F. Korkeusjanat leikkaavat yhdessä pisteessä H, ja kunkin korkeusjanan jalka on merkitty suoralla kulmalla.](06%20Jännenelikulmiot.assets/kuusi.svg)
...
![Kolmio ABC, jonka sivuilla ovat pisteet D, E ja F. Kolmioiden AEF ja BDF ympärysympyrät on piirretty, ja niiden toinen leikkauspiste on M. Katkoviivalla on piirretty kolmas ympyrä pisteiden C, M ja D kautta, ja kaikki kolme ympyrää kulkevat pisteen M kautta.](06%20Jännenelikulmiot.assets/miquel.svg)
...
![Kolmio ABC ja sen sisään piirretty ympyrä, joka sivuaa kaikkia kolmea sivua. Ympyrä on piirretty katkoviivalla ja sen keskipiste on merkitty pisteeksi I.](06%20Jännenelikulmiot.assets/sisaympyra.svg)
