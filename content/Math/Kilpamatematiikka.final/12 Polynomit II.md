...
![Koordinaatisto, jossa on punaisella piirretty nousevan polynomin y = x^3 + x + 1 kuvaaja. Käyrä leikkaa x-akselin kerran, noin kohdassa x on -0,68. Merkittyinä ovat pisteet, joissa käyrä on x-akselin alapuolella pisteessä (-1, -1) ja yläpuolella pisteessä (0, 1).](12 Polynomit II.assets/kuvaaja.svg)
