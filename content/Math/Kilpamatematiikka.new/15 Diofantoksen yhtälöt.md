...
Alla esitetään yleisiä ideoita ja menetelmiä Diofantoksen yhtälöiden ratkaisemiseksi. Tärkeimpiä perusmenetelmiä on kolme: tekijöihinjako, modulotarkastelut ja epäyhtälöt.
  ...
  <a id="tekijöihinjako"></a>

## 15.2 Tekijöihinjako

       <a id="exr-dio1"></a>

**Tehtävä 15.1** Etsi kaikki positiiviset kokonaisluvut $x$ ja $y$, joilla $$x^2 - y^2 = 123.$$
...
**Kommentti.** Vaikka ratkaisu on melko lyhyt ja tehtävä [15.1](#exr-dio1) on helpommasta päästä Diofantoksen yhtälöitä, niin silti tehtävän ratkaisemiseksi tarvittiin useampi eri menetelmä: tekijöihinjako, aritmetiikan peruslause ja yhtälöparin ratkaisu.
...
**Tehtävä 15.2** Etsi kaikki positiiviset kokonaisluvut $x$ ja $y$, joilla $$x^2 - 3y^2 = 123.$$
...
Vastaavalla taulukoinnilla huomataan, että $-3y^2$ saa vain arvoja $0$ ja $1$ modulo $4$.<a id="fnref1"></a>[^1](#fn1) Eli luku $x^2 - 3y^2$ on joko $0, 1$ tai $2$ modulo $4$. Erityisesti se ei ole koskaan $3 \pmod{4}$.
...
**Tehtävä 15.5** Etsi kaikki positiiviset kokonaisluvut $x$ ja $y$, joilla $$3^x - 2^y = 1.$$
...
**Tehtävä 4.** Etsi kaikki positiiviset kokonaisluvut $x$ ja $n$, joilla $x^2 + 1 = n!$. (Tässä $n! = n \dot (n-1) \cdot \ldots \cdot 2 \cdot 1$ on [Laskennallinen kombinatoriikka](09%20Laskennallinen%20kombinatoriikka.md) -tekstistä tuttu kertoma.)
