...
![Ympyrä ja sen ulkopuolinen piste P vasemmalla. Pisteestä P lähtee kaksi suoraa, jotka leikkaavat ympyrän: toinen ensin pisteessä A ja sitten B, toinen ensin pisteessä C ja sitten D.](24 Pisteen potenssi ja radikaaliakselit.assets/potenssi.svg)
...
![Ympyrä, jonka sisällä on piste P. Kaksi jännettä, A B ja C D, leikkaavat toisensa pisteessä P ympyrän sisällä.](24 Pisteen potenssi ja radikaaliakselit.assets/potenssi2.svg)
...
![Ympyrä ja ulkopuolinen piste P vasemmalla. Pisteestä P lähtee ympyrää sivuava tangentti, joka koskettaa ympyrää pisteessä A, sekä ympyrän leikkaava suora, joka kulkee pisteiden C ja D kautta.](24 Pisteen potenssi ja radikaaliakselit.assets/potenssi3.svg)
...
![Kaksi toisensa leikkaavaa ympyrää, joiden leikkauspisteet ovat A ja B. Leikkauspisteiden kautta kulkevaa suoraa on jatkettu pisteeseen P, joka on katkoviivalla yhdistetty pisteeseen B.](24 Pisteen potenssi ja radikaaliakselit.assets/radikaaliakseli.svg)
...
![Kaksi eri kokoista ympyrää koordinaatistossa niin, että molempien keskipisteet ovat vaaka-akselilla. Kuvaan on merkitty piste P.](24 Pisteen potenssi ja radikaaliakselit.assets/radikaaliakseliTod.svg)
...
![Kolme eri kokoista ympyrää ja niiden pareittaiset radikaaliakselit suorina. Kaikki kolme suoraa leikkaavat samassa pisteessä P.](24 Pisteen potenssi ja radikaaliakselit.assets/kolmeakselia.svg)
...
![Ympyrän kehällä oleva nelikulmio A B C D. Sivun C D keskipiste on M, ja ympyrän sisällä on piste P. Janat P A, P B, C M ja D M on merkitty poikkiviivoin keskenään yhtä pitkiksi.](24 Pisteen potenssi ja radikaaliakselit.assets/BT2016.svg)
...
![Sama kuvio, johon on lisätty kaksi pisteviivoin piirrettyä ympyrää: P-keskinen ympyrä pisteiden A ja B kautta sekä M-keskinen ympyrä pisteiden C ja D kautta.](24 Pisteen potenssi ja radikaaliakselit.assets/BT2016_2.svg)
...
![Kolmio A B C ja kaksi ympyrää, joiden halkaisijat ovat sivut A B ja A C. Kärjestä C piirretty korkeussuora leikkaa A B -halkaisijaisen ympyrän pisteissä M ja N, ja kärjestä B piirretty korkeussuora leikkaa A C -halkaisijaisen ympyrän pisteissä P ja Q.](24 Pisteen potenssi ja radikaaliakselit.assets/USAMO1990P5.svg)
...
![Sama kuvio täydennettynä kärjestä A piirretyllä korkeusjanalla ja kolmion ortokeskuksella H, jonka kautta kaikki kolme korkeussuoraa kulkevat.](24 Pisteen potenssi ja radikaaliakselit.assets/USAMO1990P5v2.svg)
...
![Pelkkä kolmio A B C ilman ympyröitä. Ympyröiden säteet ovat nollia, joten ne kutistuvat kolmion kärkipisteiksi.](24 Pisteen potenssi ja radikaaliakselit.assets/nollasade.svg)
...
![Kolmio A B C, jonka kolme korkeusjanaa on piirretty katkoviivoin ja niiden kantapisteet ovat D, E ja F. Pisteviivoin on piirretty kolmioiden A B D, B C E ja C A F ympärysympyrät.](24 Pisteen potenssi ja radikaaliakselit.assets/korkeusjanat.svg)
...
![Kolmio A B C, jonka sivun B C keskipiste on M. Kaksi ympyrää kulkevat kumpikin pisteiden A ja P kautta, toinen lisäksi pisteen B ja toinen pisteen C kautta. Piste P on katkoviivalla piirretyllä janalla A M.](24 Pisteen potenssi ja radikaaliakselit.assets/tangenttiympyrat.svg)
...
![Kolmio A B C ympärysympyrällään. Sivulla B C on piste D ja kolmion ulkopuolella piste E niin, että jana D E on yhdensuuntainen sivun A B kanssa. Jana C E leikkaa ympärysympyrän pisteessä F. Katkoviivoin on piirretty kolmion B D E ympärysympyrä.](24 Pisteen potenssi ja radikaaliakselit.assets/APMO.svg)
...
![Kolmio A B C ja sen ortokeskus H. Kunkin sivun keskipisteeseen on piirretty pisteen H kautta kulkeva ympyrä, joka leikkaa sivun kahdessa pisteessä. Näin syntyneet kuusi pistettä A1, A2, B1, B2, C1 ja C2 ovat kaikki samalla pisteviivoin piirretyllä ympyrällä.](24 Pisteen potenssi ja radikaaliakselit.assets/IMO2008P1.svg)
